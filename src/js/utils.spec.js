...
describe("Utils testing suite", function () {
    ...
    it("getWallet returns correct wallet if it exists is the local storage", function () {
        const operation = {
            description: "Salary",
            amount: 1000,
            type: Wallet.OpType.IN
    ...
    it("getWallet returns standard wallet if it doesn't exists is the local storage", function () {
        const wallet = {
            balance: 0,
            operations: []
        }
